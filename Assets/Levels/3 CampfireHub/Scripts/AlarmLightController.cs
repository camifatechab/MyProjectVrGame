...
public class AlarmLightController : MonoBehaviour
{
    ...
    [Header("Alarm Sound")]
    public AudioSource alarmAudio;  // Drag your alarm sound here
    ...
    /// <summary> Start pulsing and enable the lights + sound. </summary>
    public void ActivateAlarms()
    {
        isPulsing = true;
        pulseTimer = 0f;
    ...
    /// <summary> Stop pulsing and disable the lights + sound. </summary>
    public void DeactivateAlarms()
    {
        isPulsing = false;
